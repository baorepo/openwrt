...
# sed -i '26d' ./luasrc/controller/admin/status.lua  | grep bandwidth_status
# grep -n bandwidth_status  ./luasrc/controller/admin/status.lua |  awk -F  ":" '{print $1}'
# sed -i '26 i\       anything' ./luasrc/controller/admin/status.lua 
